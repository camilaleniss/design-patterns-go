...
// then make another to filter by size
...
// then make another to filter by size and color... but this seems weird
// we should be rewriting what we already did
...
// and a better filter that just need to receive the specification which
// implements the IsSatisfied method
