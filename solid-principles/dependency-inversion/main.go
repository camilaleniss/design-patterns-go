...
type Research struct {
	...
	// if we have that attribute we are relying in a low-level module
	browser RelationshipBrowser // low-level
}

func (r *Research) Investigate() {
	// if there is any change in the way the relation has stored the relations
	// it breaks everything in a high-level module
