...
func UseIt(sized Sized) {
	...
	sized.SetHeight(10)
	// this works for the rectangle
	// but it does not work for the square cause it does not know that the square will set the width again
	// then the width value that we have here is no longer the width value
	// So, it breaks the Liscov Substitution Principle
